...
namespace Alura.CoisasAFazer.Testes
{
    ...
    public class GerenciaPrazoDasTarefasHandlerExecuteTest
    {
        [Fact]
        public void QuandoTarefasEstiveremAtrasadas_DeveMudarSeuStatus()
        {
            // arrange
            ...
            var tarefas = new List<Tarefa>
            {
                ...
                new Tarefa(9, "TIr à academia", saudCateg, new DateTime(2018,12,31), null, StatusTarefa.Criada),
        ...
        [Fact]
        public void QuandoExecuteForInvocadoDeveChamarAtualizarTarefasNaQtdeVezesDoTotalDeTarefasAtrasadas()
        {
            // arrange
            var categ = new Categoria("Dumy");
            var tarefas = new List<Tarefa> 
            {
                ...
                new Tarefa(9, "TIr à academia", categ, new DateTime(2018,12,31), null, StatusTarefa.Criada),
            };

            var mock = new Mock<IRepositorioTarefas>();
            mock.Setup(t => t.ObtemTarefas(It.IsAny<Func<Tarefa, bool>>()))
                .Returns(tarefas);
