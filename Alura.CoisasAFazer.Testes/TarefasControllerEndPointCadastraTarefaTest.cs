...
{
    public class TarefasControllerEndPointCadastraTarefaTest
    {
        [Fact]
        public void DadaTarefaComInformacoesValidas_DeveRetornar200()
        {
            // arrange
        ...
        [Fact]
        public void QuandoExcecaoForLancada_DeveRetornar500()
        {
            // arrange
            var mockLogger = new Mock<ILogger<CadastraTarefaHandler>>();
